...
@section('page_header')
    <div class="container-fluid">
        ...
        @endcan --}}
        <a href="{{ route('users.export') }}" class="btn btn-success btn-add-new">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                                ...
                                                @elseif($row->type == 'multiple_images')
                                                    ...
                                                    @if($images)
                                                        ...
                                                        @foreach($images as $image)
                                                            <img src="{{ url('storage') . '/' . $image }}"  style="width:100px">
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            @can('delete', $data)
                                                @if ($data->role_id == '2' || $data->role_id == '' || $data->role_id == '5' || $data->role_id == '6' ) 
