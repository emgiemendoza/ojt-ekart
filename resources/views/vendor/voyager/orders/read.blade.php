...
@section('page_header')
    <h1 class="page-title">
        ...
        <a href="{{ route('orders.exportSlip', $dataTypeContent) }}" class="btn btn-success">
...
#order_products td, #customers th {
  border: 1px solid #ddd;
  padding: 8px;
}

#order_products tr:nth-child(even){background-color: #f2f2f2;}

#order_products tr:hover {background-color: #ddd;}
                        ...
                        <div class="panel-body" style="padding-top:0;">
                            ...
                            @if($row->type == "image")
                                <img class="img-responsive"
                                    src="{{ url('storage') . '/' . $dataTypeContent->{$row->field} }}">
