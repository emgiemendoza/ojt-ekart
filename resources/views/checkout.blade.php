        ...
        <div class="checkout-section">
            <div>
                <form action="{{ route('checkout.store') }}" method="POST" id="payment-form">
                    ...
                    <div class="form-group">
                        <label for="name">Pick Up By (Name/Date/Time)</label>
                    ...
                    <div class="half-form">
                        {{-- <div class="hidden">
                            ...
                            <input type="hidden" class="form-control" id="province" name="province" value="{{ old('province') }}" >
                        </div> --}}
                        <div class="form-group">
                            <label for="province">Department</label>
                    ...
                    <div class="half-form">
                        ...
                        {{-- <div class="hidden">
                            ...
                            <input type="hidden" class="form-control" id="phone" name="phone" value="{{ old('phone') }}" >
                        </div> --}}
                    </div> <!-- end half-form -->
                    ...
                    <h2>Payment Details</h2>
                        <div class="form-group">
                            <label for="postalcode">CASH or CREDIT</label>
            ...
            <div class="checkout-table-container">
                ...
                <div class="checkout-table">
                    ...
                    <div class="checkout-table-row">
                        ...
                        <div class="checkout-table-row-right">
                                {{-- <div class="checkout-table-price">{{ 'Php'. number_format(($item->model->price * $item->qty) / 100, 2) }}</div> --}}
                                <div class="checkout-table-price">{{ 'Php'. number_format(($item->model->price * $item->qty), 2) }}</div>
                        </div>
